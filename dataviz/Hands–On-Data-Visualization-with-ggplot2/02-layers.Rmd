...
```{r}
sf_France <- ne_countries(geounit = "france", returnclass = "sf", type = "map_units")
sf_lac <- ne_download(scale = "large", category = "physical", type = "lakes", returnclass = "sf")

ggplot(sf_France) +
  geom_sf() +
  geom_sf(data = sf_lac, color = "blue")
