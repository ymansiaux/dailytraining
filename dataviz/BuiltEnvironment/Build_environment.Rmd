...
sf_build_bln <-
  sf::read_sf(dsn = here::here("dataviz/BuiltEnvironment/data", "Gebäude__Berlin", "Berlin_Gebaeude.shp"), layer = "Berlin_Gebaeude") %>% 
...
sf_landuse_moabit <-
  sf::read_sf(dsn = here::here("dataviz/BuiltEnvironment/data", "osm_berlin_shp", "gis_osm_landuse_a_free_1.shp"), 
                              layer = "gis_osm_landuse_a_free_1") %>% 
  st_crop(c(xmin = 13.312183, ymin = 52.516297, xmax = 13.374943, ymax = 52.540985))

sf_roads_moabit <-
  sf::read_sf(dsn = here::here("dataviz/BuiltEnvironment/data", "osm_berlin_shp", "gis_osm_roads_free_1.shp"), 
...
sf_rails_moabit <-
  sf::read_sf(dsn = here::here("dataviz/BuiltEnvironment/data", "osm_berlin_shp", "gis_osm_railways_free_1.shp"), 
                              layer = "gis_osm_railways_free_1") %>% 
  st_crop(c(xmin = 13.312183, ymin = 52.516297, xmax = 13.374943, ymax = 52.540985))

sf_water_moabit <- 
  sf::read_sf(dsn = here::here("dataviz/BuiltEnvironment/data", "osm_berlin_shp", "gis_osm_water_a_free_1.shp"), 
...
bln <- 
  sf_build_bln %>% 
  mutate(levels = pmin(AnzahlDerO, 10L)) %>% 
  ggplot() + 
    geom_sf(aes(fill = levels),
            color = NA) +
