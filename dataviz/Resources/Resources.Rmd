...
Pourrait etre intéresssant de s'en inspirer pour les airbnb
traits de bdx
eau ?
...
```{r data-prep}
df_emobil <-
 readxl::read_xlsx(here::here("dataviz/Resources/data/", "ladesaeulen_bnetza_und_be_emobil.xlsx")) 
...
sf_bln_districts <- 
  sf::read_sf(dsn = here::here("dataviz/Resources/data/", "Bezirke__Berlin", "Bezirke__Berlin.shp"), 
              layer = "Bezirke__Berlin") %>% 
  st_transform(crs = "+init=epsg:25833")

sf_bln_roads <- 
  sf::read_sf(dsn = here::here("dataviz/Resources/data/", "osm_berlin_shp", "gis_osm_roads_free_1.shp"), 
