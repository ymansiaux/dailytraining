---
title: "#30DayMapChallenge Day 1: Points - NYC Squirrels by NYC Squirrel Census"
...
## ggplot theme
source(here::here("dataviz", "NYC_Squirrels", "tidy_grey.R"))
...
cp <- sf::st_read(dsn = here::here("dataviz", "NYC_Squirrels", "data", "CentralPark.shp"), layer = "CentralPark")
```
...
map_density <-
  ggplot(df_squirrels) +
    ...
    rcartocolor::scale_color_carto_c(palette = "Burg",
                                     breaks = c(4, 44.5, 86),
...
ggsave(here::here("contributions", "Day01_Points", "Points_Squirrels.pdf"),
